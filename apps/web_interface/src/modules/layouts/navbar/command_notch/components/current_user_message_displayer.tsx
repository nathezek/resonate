...
const CurrentUserMessageDisplayer = () => {
    ...
    return (
        <div className="w-full flex items-center h-fit truncate line-clamp-2 px-4 py-2 gap-x-4 rounded-b-xl rounded-t-lg bg-neutral-800/90 text-neutral-200 text-sm">
